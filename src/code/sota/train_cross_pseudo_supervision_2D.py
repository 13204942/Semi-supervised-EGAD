    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num % 250 == 0:
                ...
                cv2.imwrite(f"{args.root_path}/ssl/assets_CPS_unext_{labeled_slice}/image_{iter_num}.png",np.transpose(image_save.data.cpu().numpy(),(1,2,0))) 
                ...
                print('-'*20)
                cv2.imwrite(f"{args.root_path}/ssl/assets_CPS_unext_{labeled_slice}/outputs1_{iter_num}.png",img1_outputs.data.cpu().numpy())
                ...
                cv2.imwrite(f"{args.root_path}/ssl/assets_CPS_unet_{labeled_slice}/labs_{iter_num}.png",np.transpose(labs_tensor.data.cpu().numpy(),(1,2,0)))
