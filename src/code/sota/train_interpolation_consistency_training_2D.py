    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            ict_mix_factors = np.random.beta(
                args.ict_alpha, args.ict_alpha, size=(unlabeled_bs//2, 1, 1, 1))
            ...
            outputs, _ = model(input_volume_batch)
            ...
            consistency_loss = torch.mean((outputs_soft[args.labeled_bs:] - batch_pred_mixed) ** 2)
