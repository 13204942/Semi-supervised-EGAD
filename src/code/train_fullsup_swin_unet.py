...
def train(args, snapshot_path):
    ...
    db_train_labled = USDataSets(base_dir=args.root_path, split="suptrain", num=342, islabeled=True, 
                                         transform=tr_transforms, default_transform=tensor_transforms) 
    
    db_train = db_train_labled
    total_slices = len(db_train)
    db_val = USDataSets(base_dir=args.root_path, split="val", num=val_size, transform=None, default_transform=tensor_transforms)
